...
import network3_nbb
network3_nbb.set_GPU(True)

from network3_nbb import sigmoid, tanh, ReLU, Network
from network3_nbb import ConvPoolLayer, FullyConnectedLayer, SoftmaxLayer
...
def dbl_conv_relu(lmbda = 0.001, epochs=1):
    ...
    for j in range(1):
        ...
        net = Network([
            ...
            SoftmaxLayer(n_in=100, n_out=10)], mini_batch_size)
        acc_array = net.SGD(training_data, epochs, mini_batch_size, 0.03, validation_data, test_data, lmbda=lmbda)
    return [net, acc_array,lmbda,epochs]
